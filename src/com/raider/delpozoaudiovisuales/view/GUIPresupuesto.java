...
/**
 * Created by PMata on 4/10/16.
 */
public class GUIPresupuesto {

    private PresupuestoController pc;
    ...
    private JLabel noLB;
    private JDateChooser validezDC;
    ...
    public GUIPresupuesto(DbMethods dbm, BaseWindow mw) {

        this.pc = new PresupuestoController(dbm, GUIPresupuesto.this);
        this.mw = mw;
    ...
    public PresupuestoController getPc() {
        return pc;
    }

    public void setPc(PresupuestoController pc) {
        this.pc = pc;
    }
    ...
    public JDateChooser getValidezDC() {
        return validezDC;
    }

    public void setValidezDC(JDateChooser validezDC) {
        this.validezDC = validezDC;
    }
